...
AUTHENTICATION_BACKENDS = [
    'api.authentication.UserIdAuthBackend',
...
MIDDLEWARE = [
    ...
    # 'harvy_be.middleware.CustomLoggingMiddleware',
]

ROOT_URLCONF = 'harvy_portfolio.urls'
...
WSGI_APPLICATION = 'harvy_portfolio.wsgi.application'
